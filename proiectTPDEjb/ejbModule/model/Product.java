...
public class Product implements Serializable {
	...
	public void setShoppingcartproducts(List<Shoppingcart> shoppingcarts) {
		this.shoppingcarts = shoppingcarts;
	}

	public Shoppingcart addShoppingcartproduct(Shoppingcart shoppingcart) {
		getShoppingcartproducts().add(shoppingcart);
		shoppingcart.setProduct(this);

		return shoppingcart;
	}

	public Shoppingcart removeShoppingcartproduct(Shoppingcart shoppingcart) {
		getShoppingcartproducts().remove(shoppingcart);
