...
//	@Override
//	public ProductDTO existsSpecifiedProduct(ProductDTO productDTO) {
//		Product product = new Product();
//		try {
//			product = entityManager.createNamedQuery("findSpecifiedProduct", Product.class)
//					.setParameter("name", productDTO.getName()).setParameter("description", productDTO.getDescription())
//					.setParameter("categoryId", productDTO.getCategory() == null ? 0 : productDTO.getCategory().getId())
//					.getSingleResult();
//
//		} catch (NoResultException e) {
//			return null;
